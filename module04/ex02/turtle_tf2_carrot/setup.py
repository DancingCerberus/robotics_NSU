...
setup(
    ...
    entry_points={
        'console_scripts': ['static_turtle_tf2_broadcaster = turtle_tf2_carrot.static_turtle_tf2_broadcaster:main',
                            ...
                            'fixed_frame_tf2_broadcaster = turtle_tf2_carrot.fixed_frame_tf2_broadcaster:main',
